...
export default (state = SHOPPING_INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case SHOPPING_LIST.ADD_ITEM:
      return {
        ...state,
        shoppingList: addItem(state.shoppingList, action.payload)
      };
    case SHOPPING_LIST.EDIT_ITEM:
      return {
        ...state,
        shoppingList: editItem(state.shoppingList, action.payload)
      };
    case SHOPPING_LIST.REMOVE_ITEM:
      return {
        ...state,
        shoppingList: removeItem(state.shoppingList, action.payload)
      };
    case SHOPPING_LIST.INCREMENT_QUANTITY:
      return {
        ...state,
        shoppingList: incrementQuantity(state.shoppingList, action.payload)
      };
    case SHOPPING_LIST.DECREMENT_QUANTITY:
      return {
        ...state,
        shoppingList: decrementQuantity(state.shoppingList, action.payload)
      };
